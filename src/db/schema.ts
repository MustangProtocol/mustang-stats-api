...
export const branchStats = pgTable(
  'branch_stats',
  {
    ...
    spApy: numeric('sp_apy', { precision: 50, scale: 18 }).notNull(),
    apyAvg: numeric('apy_avg', { precision: 50, scale: 18 }).notNull(),
    spApyAvg1d: numeric('sp_apy_avg_1d', { precision: 50, scale: 18 }).notNull(),
    spApyAvg7d: numeric('sp_apy_avg_7d', { precision: 50, scale: 18 }).notNull(),
